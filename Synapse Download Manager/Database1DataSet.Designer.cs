...
namespace Synapse_Download_Manager {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public Table1Row AddTable1Row(string Filename, string Size) {
        ...
        public partial class Table1Row : global::System.Data.DataRow {
            ...
            public string Filename {
                get {
                    try {
                        return ((string)(this[this.tableTable1.FilenameColumn]));
                    }
                ...
                set {
                    this[this.tableTable1.FilenameColumn] = value;
                }
            }
            ...
            public bool IsFilenameNull() {
                return this.IsNull(this.tableTable1.FilenameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public void SetFilenameNull() {
                this[this.tableTable1.FilenameColumn] = global::System.Convert.DBNull;
            }
...
namespace Synapse_Download_Manager.Database1DataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `Filename` IS NULL) OR (`F" +
                "ilename` = ?)) AND ((? = 1 AND `Size` IS NULL) OR (`Size` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`Filename`, `Size`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `Filename` = ?, `Size` = ? WHERE ((`ID` = ?) AND ((? = 1 AND " +
                "`Filename` IS NULL) OR (`Filename` = ?)) AND ((? = 1 AND `Size` IS NULL) OR (`Si" +
                "ze` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Synapse_Download_Manager.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Filename, [Size] FROM Table1";
        ...
        public virtual int Delete(int Original_ID, string Original_Filename, string Original_Size) {
        ...
        public virtual int Insert(string Filename, string Size) {
            if ((Filename == null)) {
        ...
        public virtual int Update(string Filename, string Size, int Original_ID, string Original_Filename, string Original_Size) {
            if ((Filename == null)) {
